...
export default function Contact() {
  ...
  return (
    <section className="w-screen h-screen max-h-screen  bg-white flex flex-col " id="contact">
      ...
      <div className="w-full h-[15rem] text-left text-4xl Thai-light flex flex-col content-center justify-center items-center">
        <p className="w-[80%]">📞 <span className="Thai-EX text-[#24149B]">ติดต่อเรา :</span> 089-788-0964</p>
        <p className="w-[80%]">📍 <span className="Thai-EX text-[#24149B]">ที่ตั้ง :</span>  253/969 ถ.เคหะร่มเกล้า64 เขต ลาดกระบัง แขวง คลองสองต้นนุ่น</p>
        <p className="w-[80%]">📌 <span className="Thai-EX text-[#24149B]">Facebook :</span> Gina English Center</p>
      </div>
