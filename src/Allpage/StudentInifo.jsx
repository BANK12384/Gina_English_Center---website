...
export default function Studentinfo() {
  ...
  return (
    ...
    >
      ...
      {/* ------------------------------------------------------------------------------------------------------------------------------- */}
      {/* Moblie */}
      <div className="w-full h-full lg:hidden flex flex-col justify-center place-content-center place-items-center">
        <div className="absolute inset-0 lg:bg-[url('/img/StudentInifo.svg')] bg-center bg-cover bg-fixed h-full z-10"></div>
        <div className="absolute inset-0 bg-black bg-opacity-55 z-10"></div>
