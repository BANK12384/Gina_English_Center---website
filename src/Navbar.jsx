...
export default function HamburgerMenu() {
  ...
  return (
    <div className="fixed shadow-lg w-full h-[3.5rem] z-50 bg-white  Eng">
      ...
      <div
        className={`fixed top-0 right-0 w-[500px] h-screen shadow-lg transition-transform duration-300 ease-in-out transform ${
          isOpen ? "translate-x-0" : "translate-x-full"
        } bg-white z-40 overflow-hidden`}
      >
        <nav className="opacity-70 w-full pt-[3.5rem] pb-8 text-xl">
          <ul className="list-none relative z-10">
            {isHome ? (
              <li className="py-5 px-8 bg-[#24149B] text-white hover:bg-[#AF9D65] hover:border-2 hover:border-white">
            ...
            {isHome ? (
              <>
                <li className="py-5 px-8 bg-[#E66291] text-white hover:bg-[#AF9D65] hover:border-2 hover:border-white">
                  <a href="#Page2" onClick={toggleMenu}>Page2</a>
                </li>
                <li className="py-5 px-8 bg-[#D97C75] text-white hover:bg-[#AF9D65] hover:border-2 hover:border-white">
                  <a href="#teachers" onClick={toggleMenu}>Teachers</a>
                </li>
                <li className="py-5 px-8 bg-[#F2CF67] text-white hover:bg-[#AF9D65] hover:border-2 hover:border-white">
